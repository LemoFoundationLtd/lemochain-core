...
func TestNew(t *testing.T) {
	...
	consoleObj, err := New(Config{
		DocRoot: "scripts file", // this file is not exist in test
		Client:  client,
	})
	...
	consoleObj.Interactive() // It's an loop in test
}
...
// 	"time"
//
// 	"github.com/LemoFoundationLtd/lemochain-core/lemo"
...
// func newTester(t *testing.T, confOverride func(config *node.LemoConfig)) *tester {
...
// 	}
//
// 	// Create a networkless protocol stack and start an Lemochain service within
// 	stack, err := node.New(&node.LemoConfig{
// 		Genesis:   chain.DefaultGenesisBlock(),
// 		NetworkId: 1,
// 		MaxPeers:  1000,
// 		Port:      60001,
// 	}, &node.DefaultNodeConfig, map[string]string{})
//
// 	if err != nil {
// 		t.Fatalf("failed to create node: %v", err)
// 	}
// 	lemoConf := &node.LemoConfig{
// 		Genesis:   chain.DefaultGenesisBlock(),
// 		NetworkId: 1,
// 		MaxPeers:  1000,
// 		Port:      60001,
...
// 	}
//
// 	if err = stack.Register(func(ctx *node.ServiceContext) (node.Service, error) { return lemo.New(ctx, lemoConf) }); err != nil {
// 		t.Fatalf("failed to register Lemochain protocol: %v", err)
// 	}
...
// 	var lemochain *lemo.Lemochain
// 	stack.Service(&lemochain)
//
// 	return &tester{
// 		workspace: workspace,
// 		stack:     stack,
