...
import (
	...
	"github.com/LemoFoundationLtd/lemochain-core/main/jsre/deps"
...
var (
	BabelPolyfillJS, _ = deps.Asset("babel-polyfill.js")
	LemoCoreSdkJS, _   = deps.Asset("lemo-core-sdk.js")
	LemoNodeAdminJS, _ = deps.Asset("lemo-node-admin.js")
)
