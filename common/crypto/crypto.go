...
func PubToAddress(pub []byte) common.Address {
	hashPubBytes := Keccak256(pub[1:])[:19]
	versionPubBytes := append([]byte{addressVersion}, hashPubBytes...)
	return common.BytesToAddress(versionPubBytes)
}
