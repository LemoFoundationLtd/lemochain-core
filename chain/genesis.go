...
var DefaultDeputyNodes = deputynode.DeputyNodes{
	...
	&deputynode.DeputyNode{
		LemoBase: decodeLemobase("Lemo83JW7TBPA7P2P6AR9ZC2WCQJYRNHZ4NJD4CY"),
	...
	&deputynode.DeputyNode{
		LemoBase: decodeLemobase("Lemo842BJZ4DKCC764C63Y6A943775JH6NQ3Z33Y"),
	...
	&deputynode.DeputyNode{
		LemoBase: decodeLemobase("Lemo837QGPS3YNTYNF53CD88WA5DR3ABNA95W2DG"),
	...
	&deputynode.DeputyNode{
		LemoBase: decodeLemobase("Lemo83HKZK68JQZDRGS5PWT2ZBSKR5CRADCSJB9B"),
...
func decodeLemobase(input string) common.Address {
	if lemoBase, err := common.StringToAddress(input); err == nil {
		return lemoBase
	}
