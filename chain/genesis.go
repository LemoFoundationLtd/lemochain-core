...
var DefaultDeputyNodes = deputynode.DeputyNodes{
	&deputynode.DeputyNode{
		LemoBase: getLemoBase("Lemo83GN72GYH2NZ8BA729Z9TCT7KQ5FC3CR6DJG"),
	...
	&deputynode.DeputyNode{
		LemoBase: getLemoBase("Lemo83JW7TBPA7P2P6AR9ZC2WCQJYRNHZ4NJD4CY"),
	...
	&deputynode.DeputyNode{
		LemoBase: getLemoBase("Lemo842BJZ4DKCC764C63Y6A943775JH6NQ3Z33Y"),
	...
	&deputynode.DeputyNode{
		LemoBase: getLemoBase("Lemo837QGPS3YNTYNF53CD88WA5DR3ABNA95W2DG"),
	...
	&deputynode.DeputyNode{
		LemoBase: getLemoBase("Lemo83HKZK68JQZDRGS5PWT2ZBSKR5CRADCSJB9B"),
