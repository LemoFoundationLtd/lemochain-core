...
func Test_voteAndRegisteTx(t *testing.T) {
	...
	cand00[types.CandidateKeyIncomeAddress] = "0x10000"
	...
	cand02[types.CandidateKeyIncomeAddress] = "0x222222"
	...
	changeCand00[types.CandidateKeyIncomeAddress] = "0x222222"
...
func TestPrecomplieContract(t *testing.T) {
	...
	data := setRewardTxData(0, new(big.Int).Div(params.RewardPoolTotal, common.Big2))
	...
	assert.Equal(t, new(big.Int).Div(params.RewardPoolTotal, common.Big2), rewardMap[0].Value)
	...
	data02 := setRewardTxData(1, new(big.Int).Div(params.RewardPoolTotal, common.Big2))
