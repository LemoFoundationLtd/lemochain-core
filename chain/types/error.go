...
var (
	...
	ErrTxExpiration01  = errors.New("received transaction expiration time less than current time")
	ErrTxExpiration02  = errors.New("received transaction expiration time can't more than 30 minutes")
