...
func TestTransaction_EncodeRLP_DecodeRLP(t *testing.T) {
	...
	assert.NoError(t, err)
	assert.Equal(t, "f8689400000000000000000000000000000000000000018261610264010c845c107d9422830300c8a03de7cbaaff085cfc1db7d1f31bea6819413d2391d9c5f81684faaeb9835df877a04727d43924a0eb18621076607211edd7062c413d1663f29eadda0b0ee3c467fe", common.Bytes2Hex(txb))
	result = Transaction{}
	err = rlp.DecodeBytes(txb, &result)
	assert.NoError(t, err)
...
func TestTransaction_MarshalJSON_UnmarshalJSON(t *testing.T) {
	...
	assert.NoError(t, err)
	assert.Equal(t, "", common.Bytes2Hex(data))
