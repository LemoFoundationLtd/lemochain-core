...
func TestEventMultiValueWithArrayUnpack(t *testing.T) {
	...
	var rst testStruct
	assert.NoError(t, abi.Unpack(&rst, "test", b.Bytes()))
	assert.Equal(t, [2]uint8{1, 2}, rst.Value1)
	assert.Equal(t, uint8(3), rst.Value2)
}
...
/*
Taken from
https://github.com/LemoFoundationLtd/lemochain-core/pull/15568
*/
...
func TestEventUnpackIndexed(t *testing.T) {
	...
	var rst testStruct
	assert.NoError(t, abi.Unpack(&rst, "test", b.Bytes()))
	assert.Equal(t, uint8(0), rst.Value1)
	assert.Equal(t, uint8(8), rst.Value2)
}
...
func TestEventIndexedWithArrayUnpack(t *testing.T) {
	...
	var rst testStruct
	assert.NoError(t, abi.Unpack(&rst, "test", b.Bytes()))
	assert.Equal(t, [2]uint8{0, 0}, rst.Value1)
	assert.Equal(t, stringOut, rst.Value2)
}
