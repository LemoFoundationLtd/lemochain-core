...
import (
	...
	"github.com/LemoFoundationLtd/lemochain-core/common/crypto/bn256"
...
func (c *setRewardValue) Run(input []byte) ([]byte, error) {
	...
	if newReward.Term*params.TermDuration+params.InterimDuration <= c.blockHeight {
...
func (c *ecrecover) Run(input []byte) ([]byte, error) {
	...
	addr := crypto.PubToAddress(pubKey)
