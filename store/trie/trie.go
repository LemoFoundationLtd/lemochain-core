...
func New(root common.Hash, db *store.TrieDatabase) (*Trie, error) {
	if db == nil {
...
func (t *Trie) hashRoot(db *store.TrieDatabase, onleaf LeafCallback) (node, node, error) {
	if t.root == nil {
