...
func (h *hasher) hash(n node, db *store.TrieDatabase, force bool) (node, node, error) {
...
func (h *hasher) hashChildren(original node, db *store.TrieDatabase) (node, node, error) {
	var err error
...
func (h *hasher) store(n node, db *store.TrieDatabase, force bool) (node, error) {
