...
func newEmpty() *Trie {
	...
	trie, _ := New(common.Hash{}, store.NewTrieDatabase(diskdb))
	return trie
}
...
func TestMissingRoot(t *testing.T) {
	diskdb, _ := store.NewMemDatabase()
	trie, err := New(common.HexToHash("0beec7b5ea3f0fdbc95d0dd47f3c5bc275da8a33"), store.NewTrieDatabase(diskdb))
	if trie != nil {
...
func testMissingNode(t *testing.T, memonly bool) {
	diskdb, _ := store.NewMemDatabase()
	triedb := store.NewTrieDatabase(diskdb)
...
func TestCacheUnload(t *testing.T) {
	...
	db := &countingDB{Database: trie.db.DiskDB4Test(), gets: make(map[string]int)}
	trie, _ = New(root, store.NewTrieDatabase(db))
...
//
//	if commit {
//		ldb := trie.db.diskdb.(*LDBDatabase)
//		ldb.Close()
...
//func tempDB() (string, *TrieDatabase) {
//	dir, err := ioutil.TempDir("", "trie-bench")
//	if err != nil {
//		panic(fmt.Sprintf("can't create temporary directory: %v", err))
//	}
//	diskdb, err := NewLDBDatabase(dir, 256, 0)
//	if err != nil {
//		panic(fmt.Sprintf("can't create temporary database: %v", err))
//	}
//	return dir, NewTrieDatabase(diskdb)
//}
