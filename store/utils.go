...
func Byte2Uint32(val []byte) uint32 {
	var init32 = 0x811c9dc5
	var prime32 = 0x01000193
...
func GetPos(bucketIndex uint32, itemIndex uint32) uint32 {
	itemIndex = itemIndex & 0xffff
	return (bucketIndex << 16) | itemIndex
}
