...
var deputyNodes = types.DeputyNodes{
	&types.DeputyNode{
		...
		Rank:         0,
		Votes:        new(big.Int).SetInt64(50000),
	},
	&types.DeputyNode{
		...
		Rank:         1,
		Votes:        new(big.Int).SetInt64(40000),
	},
	&types.DeputyNode{
		...
		Rank:         2,
		Votes:        new(big.Int).SetInt64(30000),
	},
	&types.DeputyNode{
		...
		Rank:         3,
		Votes:        new(big.Int).SetInt64(20000),
	},
	&types.DeputyNode{
		...
		Rank:         4,
		Votes:        new(big.Int).SetInt64(10000),
	},
}
